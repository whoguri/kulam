...
export const metadata = {
    title: `Terms | ${APP_NAME}`, description: "",
};

export default function Terms() {
    return <Layout title="Terms">
        <div className="2xl:max-w-7xl xl:max-w-6xl max-w-[90%] mx-auto py-10">
            <div className="md:p-8 p-4 md:w-[70%] w-full mx-auto bg-white rounded-xl">
                <div className="capitalize md:text-[46px] text-3xl font-bold text-center md:pb-10 pb-5">terms</div>
