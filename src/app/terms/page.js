...
export default function Terms() {
    return <Layout title="Terms">
        <div className="max-w-7xl md:mx-auto mx-3 py-10">
            <div className="py-8 md:px-10 px-3 md:w-[70%] w-full mx-auto bg-white rounded-xl">
                <div className="capitalize md:text-[46px] text-3xl font-bold text-center mb-5">terms</div>
