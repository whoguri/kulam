...
export default function Banner({ title = "", buttonType = "button", onClickButton, buttonTitle = "" }) {
    return <div className="bg-background relative overflow-hidden">
        ...
        <Image src="/images/title2.svg" alt="kulam" width={50} height={50} className="md:w-[100px] w-[60px] mx-auto absolute top-10 z-10 left-0" />
        <Image src="/images/title2.svg" alt="kulam" width={50} height={50} className="md:w-[100px] w-[60px] mx-auto absolute top-0 z-10 md:-right-14 -right-8 rotate-180" />
    </div>
