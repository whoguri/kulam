...
export default function Banner({ title }) {
    return <div className="bg-background relative overflow-hidden">
        <div className="md:max-w-7xl max-w-[90%] mx-auto md:pt-6 pt-4 relative z-20">
            <h2 className="md:text-[120px] text-5xl leading-none uppercase md:pb-10 pb-7 font-bold text-text text-right text-primary">{title}</h2>
        </div>
