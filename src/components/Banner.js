...
export default function Banner({ title }) {
    ...
    return <div className="bg-background relative overflow-hidden">
        <div className="md:max-w-7xl max-w-[90%] mx-auto pt-10 relative z-20">
            ...
            {isHome && <div className="md:flex gap-6 items-center justify-center md:pt-16 pt-10 md:pb-12 pb-8 relative z-20">
                <button className="px-4 py-[6px] md:text-lg text-sm rounded-lg gradient-bg text-white">Advertiser 5</button>
                <button className="px-4 py-[6px] md:text-lg text-sm rounded-lg gradient-bg text-white">Advertiser 4</button>
                <button className="px-4 py-[6px] md:text-lg text-sm rounded-lg gradient-bg text-white">Advertiser 3</button>
                <button className="px-4 py-[6px] md:text-lg text-sm rounded-lg gradient-bg text-white">Advertiser 2</button>
                <button className="px-4 py-[6px] md:text-lg text-sm rounded-lg gradient-bg text-white">Advertiser 1</button>
            </div>}
