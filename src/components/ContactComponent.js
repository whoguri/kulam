                ...
                <div className="grid md:grid-cols-2 grid-cols-1 md:p-8 p-4 md:gap-10 gap-7 bg-white rounded-xl">
                    <div>
                        ...
                        <div>
                            ...
                            {(error === "Name is required" || error === "Name is too short") && <div className="text-red-400 text-xs">{error}</div>}
                        </div>
                        <div>
                            ...
                            {(error === "Enter email" || error === "Invalid email") && <div className="text-red-400 text-xs">{error}</div>}
                        </div>
                        <div>
                            <h3 className="paragraph pt-4 pb-2">Message<span className="text-red-600">*</span></h3>
                            ...
                            {(error === "Message is required" || error === "Message is short") && <div className="text-red-400 text-xs">{error}</div>}
                        </div>
