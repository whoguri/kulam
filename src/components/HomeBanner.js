    ...
    <div className="bg-background relative overflow-hidden">
      <div className="2xl:max-w-7xl xl:max-w-6xl max-w-[90%] mx-auto md:pt-10 pt-5 relative z-20">
        <div className="flex items-center md:gap-5 gap-2 justify-end">
          ...
          <h3 className="md:text-xl text-base text-end bg-gradient-to-r from-primary to-primary-dark text-transparent bg-clip-text inline-block">
            קובי כץ מציג
          </h3>
        </div>
        <h2 className=" xl:text-7xl text-5xl md:text-6xl leading-none uppercase md:py-3 py-[10px] font-bold text-primary text-end">
          כולם בשביל כולם
        </h2>
        <h3 className="font-thin text-[1.8rem]  md:text-4xl xl:text-[2.7rem] text-end text-primary-dark tracking-widest">
          יחד נוזיל את יוקר המחיה
        </h3>
        <div className="grid lg:grid-cols-5 grid-cols-3 2xl:w-[70%] w-full mx-auto md:gap-6 gap-3 items-center justify-center md:pt-16 pt-10 md:pb-12 pb-8 relative z-20" dir="rtl">
