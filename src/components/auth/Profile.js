            ...
            <div className="md:p-8 p-4 bg-white rounded-xl md:w-[70%] w-full mx-auto 2xl:min-h-[70vh] xl:min-h-[50vh] min-h-[60vh]">
                <div className="flex md:flex-row flex-col-reverse md:items-center items-end md:justify-between w-full">
                    ...
                    <div className='md:mt-0 mt-5'>
                        <div>
                            <div className="capitalize md:text-xl text-base md:text-start text-end">My Balance</div>
                            <div className="capitalize md:text-base text-sm md:text-start text-end">2000</div>
                    ...
                    <div className="flex items-center gap-5">
                        <div>
                            <div className="capitalize md:text-xl text-base ">{user?.name}</div>
                            <div className="capitalize md:text-base text-sm">Member Since</div>
                            <div className="capitalize md:text-base text-sm">{formatDate(user?.registerOn, "MMM yyyy")}</div>
                        </div>
                        <Image src={sessionUser?.image || "/images/user.png"} alt="user" height={150} width={150} className='border rounded-full 2xl:h-[100px] xl:h-20 2xl:w-[100px] xl:w-20 h-16 w-16' />
                    </div>
                </div>
